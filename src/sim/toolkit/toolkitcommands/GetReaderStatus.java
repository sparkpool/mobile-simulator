 ...
 * @author user
 */
public class GetReaderStatus extends BasicCommand{
    
     private static GetReaderStatus singletonInstance;
    
    private GetReaderStatus(){}
    
    public static GetReaderStatus getInstance()
    {
        if(singletonInstance == null)
        {
            singletonInstance = new GetReaderStatus();
        }
