 ...
 * @author user
 */
public class SubmitMultimediaMessage extends BasicCommand{
    
     
    private static SubmitMultimediaMessage singletonInstance;
    private String fileListTLV;
    private String multimediaMsgIdTLV;
    
    private SubmitMultimediaMessage(){}
    
    public static SubmitMultimediaMessage getInstance()
    {
        if(singletonInstance == null)
        {
            singletonInstance = new SubmitMultimediaMessage();
        }
