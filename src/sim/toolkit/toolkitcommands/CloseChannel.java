 ...
 * @author user
 */
public class CloseChannel extends BasicCommand{
    
    private static CloseChannel closeChannelInstance;
    
    private CloseChannel(){}
    public static CloseChannel getInstance()
    {
        if(closeChannelInstance == null)
        {
            closeChannelInstance = new CloseChannel();
        }
        return closeChannelInstance;
    }
