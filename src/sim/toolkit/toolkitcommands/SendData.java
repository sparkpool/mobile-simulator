 ...
 * @author user
 */
public class SendData extends BasicCommand{
      private static SendData singletonInstance;
    private String channelDataTLV;
    ...
    public static SendData getInstance()
    {
        ...
        {
            singletonInstance = new SendData();
        }
        ...
        while(tlvStartOffset<tlvendOffset)
        {
            ...
            switch (tagValue) 
            {
                ...
                case FRAME_IDENTIFIER_TAG: case (byte)(FRAME_IDENTIFIER_TAG|TAG_SET_CR):
                    ...
                    break;
                case CHANNEL_DATA_TAG: case (byte)(CHANNEL_DATA_TAG|TAG_SET_CR):
                    temp = getDataLength(command,tlvStartOffset);
                    channelDataTLV = command.substring(tlvStartOffset, tlvStartOffset+temp);
                    commandTLVList.add(channelDataTLV);
                    break;
    ...
    public String getChannelDataTLV()
    {
