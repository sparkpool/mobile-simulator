 ...
 * @author user
 */
public class PowerOnCard extends BasicCommand {
    
     private static PowerOnCard singletonInstance;
    
    private PowerOnCard(){}
    
    public static PowerOnCard getInstance()
    {
        if(singletonInstance == null)
        {
            singletonInstance = new PowerOnCard();
        }
    ...
    public String prepareTerminalResponse(String cardAtr) {
