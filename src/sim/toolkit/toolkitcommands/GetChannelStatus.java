 ...
 * @author user
 */
public class GetChannelStatus extends BasicCommand{
    
    private static GetChannelStatus singletonInstance;
    
    private GetChannelStatus(){}
    
    public static GetChannelStatus getInstance()
    {
        if(singletonInstance == null)
        {
            singletonInstance = new GetChannelStatus();
        }
