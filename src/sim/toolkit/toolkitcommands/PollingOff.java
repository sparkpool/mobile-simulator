 ...
 * @author user
 */
public class PollingOff extends BasicCommand{
    
     private static PollingOff singletonInstance;
    
    private PollingOff(){}
    
    public static PollingOff getInstance()
    {
        if(singletonInstance == null)
        {
            singletonInstance = new PollingOff();
        }
