 ...
 * @author user
 */
public class GetFrameStatus extends BasicCommand{
    
    private static GetFrameStatus singletonInstance;
    
    private GetFrameStatus(){}
    
    public static GetFrameStatus getInstance()
    {
        if(singletonInstance == null)
        {
            singletonInstance = new GetFrameStatus();
        }
